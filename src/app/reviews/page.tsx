...
export const metadata: Metadata = pageMetadata({
  ...
  description: `${COMPANY.googleRating} stars from ${COMPANY.reviewCount} Google reviews for Batres Grand Venue — a restored luxury wedding estate at 14803 Vera Dr in Humble, Texas.`,
  path: '/reviews',
});
  ...
  return (
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        <Image
          src="/hero.jpg"
          alt={`Guest reviews of ${COMPANY.name} in Humble, Texas`}
          fill
          priority
      ...
      <section className="py-20 px-6 lg:px-8 max-w-7xl mx-auto">
        <p className="mx-auto mb-12 max-w-2xl text-center text-foreground/65 leading-relaxed">
          Couples and guests share why they chose Batres Grand Venue for
          weddings and celebrations in Humble, Texas — historic architecture,
          personalized service from the Batres family, and a setting that feels like
          home.
        </p>
        ...
        <div className="mt-16 text-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#C4A35A] text-black text-xs tracking-[0.2em] uppercase font-medium hover:opacity-90 transition-opacity"
          >
