...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    'Contact Batres Grand Venue to book a private tour or inquire about wedding dates and packages. Historic luxury estate at 14803 Vera Dr, Houston, TX 77396.',
  path: '/contact',
});
