...
export const metadata: Metadata = pageMetadata({
  title: 'Luxury Wedding & Quinceañera Hall in Humble, Texas',
  description:
    'Learn about Batres Grand Venue — a 4,500 sq ft banquet hall at 14803 Vera Dr in Humble, Texas. Weddings, quinceañeras, and private celebrations for up to 250 guests, family-owned and operated.',
  path: '/about',
});
    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        <Image
          ...
          alt="Batres Grand Venue — historic luxury wedding estate in Humble, Texas"
          fill
          priority
      ...
      <section className="py-20 px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="flex flex-col gap-8">
          <h2 className="font-serif text-4xl sm:text-5xl leading-tight text-foreground">
            A restored luxury landmark in{' '}
            <em className="italic text-[#C4A35A]">Humble, Texas.</em>
          </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8 pt-8 border-t border-border">
            {[
              ...
              { number: '4,500 sq ft', label: 'Luxury Banquet Hall' },
              { number: '5★', label: `${COMPANY.reviewCount}+ Reviews` },
            ].map((stat) => (
              <div key={stat.label}>
                <p className="font-serif text-2xl text-[#C4A35A]">
                  {stat.number}
                </p>
      ...
      <section className="py-20 px-6 lg:px-8 bg-[#F8F4EE]">
