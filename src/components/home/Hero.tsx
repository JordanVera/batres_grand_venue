    ...
    >
      ...
      >
        <motion.p
          ...
          className="text-[#C4A35A] text-xs tracking-[0.4em] uppercase mb-6"
        >
          Humble, Texas · Up to {COMPANY.maxGuests} Guests
        </motion.p>
        ...
        >
          ...
          <em className="italic text-[#C4A35A]">Every Celebration</em>
        </motion.h1>
        ...
        >
          <Link
            href="/tour"
            className="px-8 py-3.5 bg-[#C4A35A] text-white text-xs tracking-[0.2em] uppercase font-medium hover:bg-[#A6863F] transition-colors duration-200"
          >
            Book a Tour
          </Link>
          <Link
            href="/contact"
            className="px-8 py-3.5 border border-white/50 text-white text-xs tracking-[0.2em] uppercase hover:border-[#C4A35A] hover:text-[#C4A35A] transition-all duration-200"
          >
            Contact Us
          </Link>
        </motion.div>
