      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-16 items-start">
          <motion.div {...anim(0)} className="flex flex-col gap-4">
            <span className="text-[#C4A35A] text-[10px] tracking-[0.35em] uppercase">
              Welcome
            </span>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              Your luxury Humble banquet hall for{' '}
              <em className="italic text-[#C4A35A]">unforgettable weddings.</em>
            </motion.h2>
            ...
            <motion.div {...anim(0.4)} className="flex gap-8 pt-4 border-t border-border">
              {[
                ...
                <div key={stat.label}>
                  <p className="font-serif text-2xl text-[#C4A35A]">{stat.number}</p>
            ...
            <motion.div {...anim(0.5)}>
              <Link
                href="/about"
                className="inline-flex items-center text-[#C4A35A] text-xs tracking-[0.2em] uppercase hover:underline underline-offset-4"
              >
