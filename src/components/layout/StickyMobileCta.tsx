        ...
        <div className="mx-auto flex max-w-lg items-center gap-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[10px] tracking-[0.15em] text-white/50 uppercase">
              Humble, Texas · Book your visit
            </p>
          </div>
          <Link
            href="/tour"
            tabIndex={visible ? 0 : -1}
            className="shrink-0 bg-[#C4A35A] px-5 py-3 text-[10px] font-medium tracking-[0.2em] text-black uppercase transition-colors hover:bg-[#A6863F]"
          >
            Book a Tour
          </Link>
        </div>
