    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="message"
          rows={5}
          placeholder="Share your vision, preferred date, and any questions about Batres Grand Venue."
          {...register("message")}
      ...
      <Button
        type="submit"
        disabled={loading}
        className="w-full bg-[#C4A35A] text-black hover:bg-[#A6863F] uppercase tracking-[0.15em] text-xs h-12"
      >
        {loading ? (
          <>
